   ...
   <div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="viewbuyers.jsp">View Seller</a></li>
			<li class="selected"><a href="ViewSellers.jsp">View Buyer</a></li>
        ...
        <table align="center" style="border-style: solid" border="1" width="20">
                    <caption> <h2 style="color: coral">List of Buyers </h2></caption>
